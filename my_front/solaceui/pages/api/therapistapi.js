...
import TherapistRegistrationForm from "../../components/forms/therapistform";

const TherapistRegistrationApiForm = () => {
  ...
  const handleRegister = async (userData) => {
    ...
    try {
      ...
      const restApiResponse = await axios.post(
        "https://your-express-backend.com/farewell",
        userData
      );
...
export default TherapistRegistrationApiForm;
