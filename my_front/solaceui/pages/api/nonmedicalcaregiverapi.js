...
import NonMedicalCaregiverRegistrationForm from "../../components/forms/nonmedicalcaregiversform";

const NonMedicalCaregiverRegistrationApiForm = () => {
  ...
  const handleRegister = async (userData) => {
    ...
    try {
      ...
      const restApiResponse = await axios.post(
        "https://your-express-backend.com/api/register-non-medical-caregiver",
        userData
      );
  ...
  return (
    <div className="text-center">
      ...
      <NonMedicalCaregiverRegistrationForm
...
export default NonMedicalCaregiverRegistrationApiForm;
