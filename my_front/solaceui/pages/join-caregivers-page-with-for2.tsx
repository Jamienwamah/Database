...
import styles from "./join-caregivers-page-with-for2.module.css";
          ...
          <div className={styles.frameParent}>
            ...
            <div className={styles.eachContactInfoWrapperGroup}>
              <div className={styles.eachContactInfoWrapper1}>
                ...
                <div className={styles.textContainer}>
                  <div className={styles.text3} onClick={onText18Click}>
                    Register Here
                  </div>
                </div>
              </div>
            ...
            <div className={styles.eachContactInfoWrapper2}>
              ...
              <div className={styles.textFrame}>
                <div className={styles.text5}>Register Here</div>
              </div>
            </div>
          </div>
...
export default JoinCaregiversPageWithFor2;
