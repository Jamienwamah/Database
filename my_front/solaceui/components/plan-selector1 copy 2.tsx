...
import styles from "./plan-selector1.module.css";

export type PlanSelector1Type = {
  className?: string;
};

const PlanSelector1: NextPage<PlanSelector1Type> = ({ className = "" }) => {
        ...
        <div className={styles.plansSectionvariant4}>
          <div className={styles.pricingSection}>
              ...
              <div className={styles.planTitle}>
                <div className={styles.planAmountWrapper}>
                  <div className={styles.priceWrapper}>
                    <div className={styles.text1}>₦90,000.00</div>
                  </div>
                  <div className={styles.textContainer}>
                    <div className={styles.text2}>
                      <p className={styles.perAnnual}>{`Per Annual. `}</p>
              ...
              <div className={styles.modelSpecsWrapper}>
                <div className={styles.additionalFeaturesWrapper}>
                  <div className={styles.text3}>
                    <p
                      className={styles.getServiceBenefits}
                    >{`Get Service Benefits Worth ₦2m. `}</p>
            ...
            <div className={styles.eachPricing1}>
              ...
              <div className={styles.planTitle1}>
                <div className={styles.planAmountWrapper1}>
                  <div className={styles.priceWrapper1}>
                    <div className={styles.text17}>₦150,000.00</div>
                  </div>
                  <div className={styles.frameDiv}>
                    <div className={styles.text18}>
                      <p className={styles.perAnnual1}>{`Per Annual. `}</p>
              ...
              <div className={styles.modelSpecsWrapper1}>
                <div className={styles.additionalFeaturesWrapper1}>
                  <p className={styles.text19}>
                    <span className={styles.getServiceBenefits1}>
                      Get Service Benefits Worth ₦4m.
                    </span>
              ...
              <div className={styles.planAmount1}>
                <button
            ...
            <div className={styles.eachPricing2}>
              ...
              <div className={styles.planTitle2}>
                <div className={styles.planAmountWrapper2}>
                  <div className={styles.priceWrapper2}>
                    <div className={styles.text33}>₦250,000.00</div>
                  </div>
                  <div className={styles.text34}>
                    <p className={styles.perAnnual2}>{`Per Annual. `}</p>
              ...
              <div className={styles.modelSpecsWrapper2}>
                <div className={styles.additionalFeaturesWrapper2}>
                  ...
                  >{`Get Service Benefits Worth ₦8m. (T&C Apply)`}</div>
              ...
              <div className={styles.planAmount2}>
                <button
