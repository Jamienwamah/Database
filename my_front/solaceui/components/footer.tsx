    ...
    <footer className={[styles.newFooter, className].join(" ")}>
      ...
      <div className={styles.companyDetailsWrapper}>
        <p className={styles.gmonieTechnologiesLtdContainer}>
          <span>{`© 2024 Gmonie Technologies Ltd. All rights reserved. Solace is a health technology platform, 
          not an insurance company or a bank. All services are provided by our licensed partners. By using this website, you accept our `}</span>
