...
const PharmacyRegistrationForm: React.FC = () => {
  ...
  const validate = () => {
    ...
    temp.pharmacyStores = formValues.pharmacyStores ? '' : 'This field is required';
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      <Container maxWidth="sm">
        <Typography variant="h4" gutterBottom>
          Solace Partnership Form For Pharmacy Owners, Nationwide
        </Typography>
        <Typography variant="subtitle1" gutterBottom>
          For Pharmacies Registered and Operating in Nigeria
        </Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Typography variant="body2" gutterBottom>
                Click to upload your PCN certificate
                <br />
                PNG or JPG (max. 50MB)
              </Typography>
              <input
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth variant="outlined" error={Boolean(errors.pharmacyStores)}>
                <InputLabel>Number of pharmacy stores nationwide</InputLabel>
                <Select
                  name="pharmacyStores"
                  value={formValues.pharmacyStores}
                ...
                {errors.pharmacyStores && <p style={{ color: 'red', fontSize: '12px' }}>{errors.pharmacyStores}</p>}
              </FormControl>
            </Grid>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth variant="outlined" error={Boolean(errors.pharmacyStores)}>
                ...
                <Grid container spacing={2} key={index}>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      label="Address of pharmacy headquarters"
                      variant="outlined"
                      fullWidth
