  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      <Container maxWidth="sm">
        <Typography variant="h4" gutterBottom>Registration Form for Certified Nutritionists</Typography>
        <Typography variant="subtitle1" gutterBottom>For Nigerian Nutritionists Only</Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                name="certificateNumber"
                label="Enter your NMCN here"
                variant="outlined"
                fullWidth
