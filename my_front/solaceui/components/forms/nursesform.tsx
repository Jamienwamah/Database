  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      <Container maxWidth="sm">
        <Typography variant="h4" gutterBottom>Registration Form for Qualified Nurses</Typography>
        <Typography variant="subtitle1" gutterBottom>For Nigerian Nurses Only</Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                name="nursingSchool"
                label="Enter Your MDCN Here"
                variant="outlined"
                fullWidth
                value={formValues.nursingSchool}
                onChange={handleChange}
                error={Boolean(errors.nursingSchool)}
                helperText={errors.nursingSchool}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <DatePicker
